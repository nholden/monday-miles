...
RSpec.describe "user monday activities request" do
  ...
  def activity(trait, distance:, elevation:, duration:, name:, strava_id:)
    FactoryGirl.create(
      :activity,
      trait,
      user: user,
  ...
  it "fetches JSON with activity data" do
    activity(:last_monday, distance: 5_000, elevation: 25, duration: 1_200, name: 'Great Monday 5k', strava_id: 123)
    activity(:two_mondays_ago, distance: 10_000, elevation: 50, duration: 3_000, name: 'Lousy Monday 10k', strava_id: 456)
    activity(:four_mondays_ago, distance: 20_000, elevation: 75, duration: 6_000, name: 'Decent Monday 20k', strava_id: 789)
    activity(:wednesday, distance: 15_000, elevation: 100, duration: 5_000, name: 'Neutral Wednesday 15k', strava_id: 135)
